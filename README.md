...
Vite + React en localhost para armar el JSON que corre el playtester (`--agent=flow`). **No** entra en `./install.sh`. Instalación con **pnpm** (`node_modules/` está en `.gitignore`).
