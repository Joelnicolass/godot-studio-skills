...
9. Playtest is not yours. The full rule is in the standards block of your prompt; in short: playtest helpers belong in `res://agent/harness/` ([godot-studio-playtest](https://github.com/Joelnicolass/godot-studio-playtest) module), never in `src/`, under any name.
